...
export default function CareerDashboard() {
  ...
  return <main className="shell">
    ...
    <section className="workspace">
      ...
      {view === "profile" && <ProfileView profile={store.profile} onSave={(profile) => { void store.setProfile(profile); setCareerLevel(profile.careerLevel); navigate("overview"); }} onSignOut={signOut} />}
    </section>
